//goal is to build an App
//which picks a random Domino tile
let dominoElements = document.querySelectorAll(".domino-list > li")
console.log(dominoElements[dominoElements.length - 1])
...
randomDominoElement.classList.add("chosen")
